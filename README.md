...
## Branch 생성
[원본 레포지토리](https://github.com/Konkuk-KUIT/KUIT7th_Android) 에서 github 이름의 branch 를 입력합니다.
...
## 저장소 Fork
1. [원본 레포지토리](https://github.com/Konkuk-KUIT/KUIT7th_Android) 에서 **Fork** -> **Create a new fork** 를 클릭합니다.
